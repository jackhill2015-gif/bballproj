...
export function renderDashboard() {
  ...
  if (G.phase === 'reg' && G.gi < 30) {
    ...
    if (confMatch) {
      ...
      var cwpc = cwp >= 50 ? 'var(--grn)' : 'var(--red)';
      h += '<div class="matchup-card" style="border-left-color:var(--blu);">'
        ...
        + '<span style="color:var(--txt2);">You are #' + userSeed + ' seed</span>'
        + '<span style="color:var(--txt2);">OVR ' + getTOvr(confOpp) + '</span>'
        + '</div>'
      ...
      h += '<div class="matchup-card">'
        ...
        + '<div class="btn btn-red btn-full" onclick="simConfRoundAll()">ADVANCE TO NCAA</div>'
        + '</div>';
    }
    ...
    if (ncaaMatch) {
      ...
      var nwpc = nwp >= 50 ? 'var(--grn)' : 'var(--red)';
      h += '<div class="matchup-card" style="border-left-color:var(--gld);">'
        + '<div style="font-size:10px;font-weight:700;color:var(--gld2);letter-spacing:1px;text-transform:uppercase;margin-bottom:8px;">NCAA Tournament \u2014 ' + ncaaRoundName + '</div>'
        ...
        + '<span style="color:var(--gld2);">You are #' + userEntry.seed + ' seed</span>'
        + '<span style="color:var(--txt2);">OVR ' + getTOvr(ncaaOpp) + '</span>'
        + '</div>'
      ...
      var active2 = G.bracket ? G.bracket.filter(function(b) { return b.active; }).length : 0;
      var rn2 = { 64: 'Round of 64', 32: 'Round of 32', 16: 'Sweet 16', 8: 'Elite Eight', 4: 'Final Four', 2: 'Championship' };
      h += '<div class="matchup-card">'
        + '<div style="font-size:11px;color:var(--txt3);margin-bottom:10px;text-transform:uppercase;letter-spacing:1px;">NCAA Tournament \u2014 ' + (rn2[active2] || '') + '</div>'
        + '<div style="font-size:12px;color:var(--txt2);margin-bottom:12px;">Your tournament run is over. Simming remaining games...</div>'
